...
dataset = pd.read_csv('D:\\Udemy - Machine Learning\\practice\\Credit Card-KMeans Clustring\\CC GENERAL.csv')
...
plt.scatter(X[y_kmeans == 2, 0], X[y_kmeans == 2, 1], s = 100, c = 'green', label = 'Carefull')
